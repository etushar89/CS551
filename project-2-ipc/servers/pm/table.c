...
int (*call_vec[])(void) = {
	...
	no_sys,		/* 42 = pipe	*/
	do_times,	/* 43 = times	*/
	do_open_q,	/* 44 = qipc - qopen	*/
	do_close_q,	/* 45 = qipc - qclose	*/
	do_set,		/* 46 = setgid	*/
	do_get,		/* 47 = getgid	*/
	no_sys,		/* 48 = (signal)*/
	no_sys,		/* 49 = unused	*/
	...
	no_sys,		/* 54 = ioctl	*/
	no_sys,		/* 55 = fcntl	*/
	do_set_attr_q,		/* 56 = unused	*/
	do_get_attr_q,		/* 57 = unused	*/
	no_sys,		/* 58 = unused	*/
	do_exec,	/* 59 = execve	*/
	no_sys,		/* 60 = umask	*/
	no_sys,		/* 61 = chroot	*/
	...
	do_send_mg_q,	/* 69 = unused	*/
	do_res_mg_q,	/* 70 = unused	*/
	...
	do_mqreqnotify,		/* 79 = request notify */
	no_sys,		/* 80 = (getdents) */
	no_sys, 	/* 81 = unused */
	no_sys, 	/* 82 = (fstatfs) */
	no_sys, 	/* 83 = unused */
	...
	do_auth_perm_public,		/* 105 = unused */
	do_get,		/* 106 = issetugid */
	do_getepinfo_o,	/* 107 = getepinfo XXX: old implementation*/
	do_auth_users,		/* 108 = unused */
	do_auth_perm_secure,	/* 109 = unused */
	do_blocking_receive,/* 110 = unused */
